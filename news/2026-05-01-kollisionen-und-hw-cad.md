---
title: Kollisionen im MeshCore-Netz
description: Ein Experiment, das sich lohnt
authors: sebastian
tags: [meshcore, repeater, hw-cad]
---

Was uns eine Notfunkübung über Paketverluste gelehrt hat und wie HW-CAD das Problem grundlegend lösen könnte.
...
Im MeshCore-Projekt gibt es dazu einen offenen Pull Request. Wir haben den Entwickler der Evo-Firmware motiviert, alle Features in seine Repeater-Firmware aufzunehmen. Dabei zeigte sich: **HW-CAD sollte nicht nur auf Repeatern aktiv sein.** Der volle Effekt entfaltet sich erst, wenn sich auch Companions rücksichtsvoll verhalten.
