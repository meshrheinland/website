...
import PowerArchitectWidget from '@site/src/components/PowerArchitectWidget';
...
| Laderegler | [CN3791 MPPT-Modul](https://de.aliexpress.com/item/1005009726210332.html) | MPPT-Spannung per Widerstand einstellbar |
